                    ...
                    {posts.map((post) => (
                        <div key={post.id} className="bg-slate-900 border border-slate-800 p-4 rounded-xl">
                            ...
                            <h3 className="text-blue-400 font-bold">
                                {post.user ? post.user.name : "Utilisateur supprimé"}
                            </h3>
                            ...
                            {/* Liste des commentaires (affichée seulement si on clique) */}
                            {openCommentsPostId === post.id && (
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    <div className="flex gap-2 mt-2">
                                        <input
                                            type="text"
                                            className="flex-1 bg-slate-800 text-white border-none rounded px-3 py-1 text-sm outline-none"
